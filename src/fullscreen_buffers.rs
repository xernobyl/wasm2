...
impl ScreenBuffers {
  pub fn init(gl: &Gl, max_width: &i32, max_height: &i32) -> Option<Self> {
    ...
    gl.tex_image_2d_with_i32_and_i32_and_i32_and_format_and_type_and_opt_u8_array(
      Gl::TEXTURE_2D, 0, Gl::DEPTH_COMPONENT24 as i32, *max_width, *max_height, 0, Gl::DEPTH_COMPONENT, Gl::UNSIGNED_INT, None);
    ...
    gl.tex_image_2d_with_i32_and_i32_and_i32_and_format_and_type_and_opt_u8_array(
      Gl::TEXTURE_2D, 0, Gl::R11F_G11F_B10F as i32, *max_width, *max_height, 0, Gl::RGB, Gl::UNSIGNED_INT_10F_11F_11F_REV, None);
    Self::set_linear_clamp(gl);

    let motion_texture = gl.create_texture();
    gl.bind_texture(Gl::TEXTURE_2D, motion_texture.as_ref());
    gl.tex_image_2d_with_i32_and_i32_and_i32_and_format_and_type_and_opt_u8_array(
      Gl::TEXTURE_2D, 0, Gl::RG16F as i32, *max_width, *max_height, 0, Gl::RG, Gl::HALF_FLOAT, None);
    Self::set_linear_clamp(gl);
    ...
    */
    ...
    gl.tex_image_2d_with_i32_and_i32_and_i32_and_format_and_type_and_opt_u8_array(
      Gl::TEXTURE_2D, 0, Gl::RG16F as i32, width, height, 0, Gl::RG, Gl::HALF_FLOAT, None);
    Self::set_linear_clamp(gl);
    ...
    gl.framebuffer_texture_2d(Gl::FRAMEBUFFER, Gl::COLOR_ATTACHMENT1, Gl::TEXTURE_2D, motion_texture.as_ref(), 0);
